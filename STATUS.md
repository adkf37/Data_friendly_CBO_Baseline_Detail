...
- **Next phase:** Human Blocked â€” rerun `python run_pipeline.py --step download` and full `python run_pipeline.py` from a network-enabled environment that can resolve and reach `https://www.cbo.gov/data/baseline-projections-selected-programs`.
...
| Task: Pipeline | `./backlog/tasks/task-06-pipeline.md` | validate blocked â€” network-enabled download/full-run smoke check pending |

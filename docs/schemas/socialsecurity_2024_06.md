...
| Field | Value |
|---|---|
| Source file(s) | `51308-2024-06-socialsecurity.xlsx` |
| Source sheet(s) | `OASI_06-2024` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51308-2024-06-socialsecurity.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `OASI_06-2024` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Parents / PIA for Hypothetical Retired Worker With / Average Earnings (Equal to AWI) (Dollars)a | `a` | Example PIAs are for workers turning 62 in the given calendar year. | Average Earnings (Equal to AWI) (Dollars)a | `51308-2024-06-socialsecurity.xlsx` / `OASI_06-2024` / R71C2 |
| Parents / PIA for Hypothetical Retired Worker With / Maximum Earnings (Dollars)a | `a` | Example PIAs are for workers turning 62 in the given calendar year. | Maximum Earnings (Dollars)a | `51308-2024-06-socialsecurity.xlsx` / `OASI_06-2024` / R73C2 |
| Parents / PIA for Hypothetical Retired Worker With / COLA (Percent)b | `b` | COLAs are effective with benefits payable for December and received by beneficiaries in January of the next calendar year. | COLA (Percent)b | `51308-2024-06-socialsecurity.xlsx` / `OASI_06-2024` / R74C1 |

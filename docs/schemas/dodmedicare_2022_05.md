...
| Field | Value |
|---|---|
| Source file(s) | `54946-2022-05-dodmedicare.xlsx` |
| Source sheet(s) | `DoD-MERHCF_05-2022` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `11316.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `54946-2022-05-dodmedicare.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `DoD-MERHCF_05-2022` | Combine with source file, row, and column for exact cell provenance. |

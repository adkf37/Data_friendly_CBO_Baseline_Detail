...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Mil Retirement_5-2022` | Combine with source file, row, and column for exact cell provenance. |

...
| Source sheet(s) | `T1-FCRA_05-2022`, `T3-Pandemic Relief_05-2022`, `T4-NewLoans-FCRA_05-2022`, `T5-Admin_05-2022`, `T7-Subsidies_05-2022`, `T8-FV_05-2022` |
| Unit(s) | Billions of dollars, by fiscal year in which costs were recorded, By Fiscal Year, Millions of Dollars, By Fiscal Year, Percent, Net Annual Loan Volume (Millions of dollars) |
...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `T1-FCRA_05-2022` | Combine with ``source_file`` for a fully qualified provenance reference. |

...
|---|---|---|---|---|
| Supplemental Nutrition Assistance Program / Total Benefitsa / Budget Authority | `a` | CBO projects the cost of the Thrifty Food Plan (TFP) using a proxy food inflator. Additionally, CBO increases its projections of the cost of the TFP in 2027 and 2032, anticipating that reevaluations of the TFP, which occur every five years, would increase costs. | Total Benefitsa | `51312-2025-01-snap.xlsx` / `SNAP_01-2025` / R18C1 |
| Supplemental Nutrition Assistance Program / Thrifty Food Plan, Estimated Change / June/June Preceding Year, Lagged (Percent)a | `a` | CBO projects the cost of the Thrifty Food Plan (TFP) using a proxy food inflator. Additionally, CBO increases its projections of the cost of the TFP in 2027 and 2032, anticipating that reevaluations of the TFP, which occur every five years, would increase costs. | June/June Preceding Year, Lagged (Percent)a | `51312-2025-01-snap.xlsx` / `SNAP_01-2025` / R37C1 |
| Supplemental Nutrition Assistance Program / NUTRITION ASSISTANCE FOR PUERTO RICO AND AMERICAN SAMOA / State Administrationb | `b` | Excludes employment and training. | State Administrationb | `51312-2025-01-snap.xlsx` / `SNAP_01-2025` / R45C1 |

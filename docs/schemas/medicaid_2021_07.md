...
| Field | Value |
|---|---|
| Source file(s) | `51301-2021-07-medicaid.xlsx` |
| Source sheet(s) | `Medicaid_07-2021` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `458.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51301-2021-07-medicaid.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Medicaid_07-2021` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Medicaid / BUDGET INFORMATION / Estimated Outlaysa | `a` | On average, before fiscal year 2014, federal Medicaid payments represented approximately 57 percent of total Medicaid payments. The ACA, which expanded Medicaid coverage starting in 2014, provides enhanced federal matching rates for services to those made eligible by that act, leading to a federal share for all Medicaid of about 65 percent, on average. In addition, the Families First Coronavirus Relief Act increased Medicaid matching rates by 6.2 percentage points for services to those not made eligible by the ACA. The American Rescue Plan Act of 2021 increased the federal medical assistance percentage by 10 percentage points for certain Medicaid home- and community-based services from April 1, 2021 through March 31, 2022, provided that states use the enhanced funding to improve those services. In total, CBO estimates, the average federal matching rate for Medicaid in 2021 and 2022 will be about 67 percent. | Estimated Outlaysa | `51301-2021-07-medicaid.xlsx` / `Medicaid_07-2021` / R14C2 |
| Medicaid / Average Monthly Enrollment by Eligibility Category (Millions of people)b / Adults—Made eligible by the ACA | `b` | These figures represent the number of beneficiaries, with full and partial benefits, who are enrolled on an average monthly basis. The total number of people enrolled in Medicaid for any length of time during the fiscal year is shown in the memorandum line. | Average Monthly Enrollment by Eligibility Category (Millions of people)b | `51301-2021-07-medicaid.xlsx` / `Medicaid_07-2021` / R45C2 |
| Medicaid / Average Monthly Enrollment by Eligibility Category (Millions of people)b / Adults—Traditional eligibility categories | `b` | These figures represent the number of beneficiaries, with full and partial benefits, who are enrolled on an average monthly basis. The total number of people enrolled in Medicaid for any length of time during the fiscal year is shown in the memorandum line. | Average Monthly Enrollment by Eligibility Category (Millions of people)b | `51301-2021-07-medicaid.xlsx` / `Medicaid_07-2021` / R45C2 |

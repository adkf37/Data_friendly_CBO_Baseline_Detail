...
| Field | Value |
|---|---|
| Source file(s) | `51314-2021-02-tanf.xlsx` |
| Source sheet(s) | `TANF 2-2021` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `16738.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51314-2021-02-tanf.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `TANF 2-2021` | Combine with source file, row, and column for exact cell provenance. |

...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Veterans' C&P_05-2023` | Combine with ``source_file`` for a fully qualified provenance reference. |

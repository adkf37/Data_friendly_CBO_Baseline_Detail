...
| Field | Value |
|---|---|
| Source file(s) | `51309-2020-01-trustfund.xlsx` |
| Source sheet(s) | `SS Trust Funds` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51309-2020-01-trustfund.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `SS Trust Funds` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Other Income / Federal payroll tax, employer sharea | `a` | Transfers from the general fund to the Social Security trust funds. Such transfers appear in the budget as both positive outlays (the general fund portion) and negative outlays, or offsetting receipts (the trust fund portion). | Federal payroll tax, employer sharea | `51309-2020-01-trustfund.xlsx` / `SS Trust Funds` / R11C1 |
| Other Income / Interesta | `a` | Transfers from the general fund to the Social Security trust funds. Such transfers appear in the budget as both positive outlays (the general fund portion) and negative outlays, or offsetting receipts (the trust fund portion). | Interesta | `51309-2020-01-trustfund.xlsx` / `SS Trust Funds` / R12C1 |

...
| Field | Value |
|---|---|
| Source file(s) | `51299-2021-07-fostercare.xlsx` |
| Source sheet(s) | `Fostercare_07-2021` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `9915.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51299-2021-07-fostercare.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Fostercare_07-2021` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Foster Care, Adoption Assistance, and Guardianship / Estimated Outlays for Other Components / Sequestrationa | `a` | The Coronavirus Aid, Relief, and Economic Security Act extended sequestration for mandatory spending through fiscal year 2030. | Sequestrationa | `51299-2021-07-fostercare.xlsx` / `Fostercare_07-2021` / R42C2 |

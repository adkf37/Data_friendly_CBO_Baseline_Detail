...
| Field | Value |
|---|---|
| Source file(s) | `51308-2021-02-socialsecurity..xlsx` |
| Source sheet(s) | `OASI_2-2021` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `940.2` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51308-2021-02-socialsecurity..xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `OASI_2-2021` | Combine with source file, row, and column for exact cell provenance. |
...
| `category_path` | string | Hierarchy-aware path from table/section headings to the leaf category. | N/A | `Social Security Old-Age And Survivors...` | Use this field instead of ``category`` when labels repeat in different subprograms. |
...
|---|---|---|---|---|
| Parents / PIA for Hypothetical Retired Worker With / Average Earnings (Equal to AWI) (Dollars)a | `a` | Example PIAs are for workers turning 62 in the given calendar year. b. Age 66 years, 8 months. c. Age 66 years, 10 months. | Average Earnings (Equal to AWI) (Dollars)a | `51308-2021-02-socialsecurity..xlsx` / `OASI_2-2021` / R70C3 |
| Parents / PIA for Hypothetical Retired Worker With / Maximum Earnings (Dollars)a | `a` | Example PIAs are for workers turning 62 in the given calendar year. b. Age 66 years, 8 months. c. Age 66 years, 10 months. | Maximum Earnings (Dollars)a | `51308-2021-02-socialsecurity..xlsx` / `OASI_2-2021` / R72C3 |
| Parents / PIA for Hypothetical Retired Worker With / COLA (Percent)d | `d` | COLAs are effective with benefits payable for December, which are received by beneficiaries in January of the next calendar year. | COLA (Percent)d | `51308-2021-02-socialsecurity..xlsx` / `OASI_2-2021` / R75C2 |

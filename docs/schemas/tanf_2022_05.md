...
| Field | Value |
|---|---|
| Source file(s) | `51314-2022-05-tanf.xlsx` |
| Source sheet(s) | `TANF_05-2022` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51314-2022-05-tanf.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `TANF_05-2022` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Temporary Assistance for Needy Families / Budget Authority for TANF Components / Sequestrationa | `a` | The Infrastructure Investment and Jobs Act extended sequestration for mandatory spending through fiscal year 2031. | Sequestrationa | `51314-2022-05-tanf.xlsx` / `TANF_05-2022` / R23C1 |

# Schema: Childsupportenforcement 2020 03
...
| Field | Value |
|---|---|
| Source file(s) | `51295-2020-03-childsupportenforcement.xlsx` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51295-2020-03-childsupportenforcement...` | Use this column to trace any row back to its exact source workbook. |

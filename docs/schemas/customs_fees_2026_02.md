...
| Field | Value |
|---|---|
| Source file(s) | `61170-2026-02-customs-fees.xlsx` |
| Source sheet(s) | `Customs Fees 02-2026` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `61170-2026-02-customs-fees.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Customs Fees 02-2026` | Combine with source file, row, and column for exact cell provenance. |
...
| `category_path` | string | Hierarchy-aware path from table/section headings to the leaf category. | N/A | `Customs User Fees / Extension Through...` | Use this field instead of ``category`` when labels repeat in different subprograms. |

...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Medicaid_05-2023` | Combine with source file, row, and column for exact cell provenance. |

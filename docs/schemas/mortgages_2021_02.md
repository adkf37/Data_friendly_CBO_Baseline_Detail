...
| Field | Value |
|---|---|
| Source file(s) | `51297-2021-02-mortgages.xlsx` |
| Source sheet(s) | `Mortgage Progs_2-2021` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `2951000.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51297-2021-02-mortgages.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Mortgage Progs_2-2021` | Combine with source file, row, and column for exact cell provenance. |
...
| `source_row` | integer | One-based worksheet row containing the numeric source value. | N/A | `19` | Together with ``source_column`` identifies the exact source cell. |
...
|---|---|---|---|---|
| Federal Programs That Guarantee Mortgages / Fannie Mae and Freddie Mac / Annual Subsidy Costsa | `a` | For 2022 through 2030, the baseline includes projected subsidy costs of new mortgage loans and guarantees made by Fannie Mae and Freddie Mac in each year, estimated on a fair-value basis. For more information about CBO's budgetary treatment of Fannie Mae and Freddie Mac, see Congressional Budget Office, CBO’s Budgetary Treatment of Fannie Mae and Freddie Mac (January 2010), www.cbo.gov/publication/41887. ʼ | Annual Subsidy Costsa | `51297-2021-02-mortgages.xlsx` / `Mortgage Progs_2-2021` / R23C3 |
| Federal Programs That Guarantee Mortgages / Fannie Mae and Freddie Mac / Cash Receiptsb | `b` | For fiscal year 2021, the baseline includes an estimate of mandatory cash payments from Fannie Mae and Freddie Mac to the Treasury. | Cash Receiptsb | `51297-2021-02-mortgages.xlsx` / `Mortgage Progs_2-2021` / R24C3 |
| Federal Programs That Guarantee Mortgages / Federal Housing Administration MMI Programc / Annual Subsidy Costs | `c` | Excludes Home Equity Conversion Mortgages; MMI subsidy receipts are recorded in the budget as offsetting collections to discretionary appropriations. The subsidy rate for the MMI program is calculated using FCRA methods. | Federal Housing Administration MMI Programc | `51297-2021-02-mortgages.xlsx` / `Mortgage Progs_2-2021` / R28C2 |
...
| Federal Programs That Guarantee Mortgages / Government National Mortgage Association Mortgage-Backed Securities Programe / Annual Subsidy Receipts | `e` | GNMA securitizes more than 90 percent of FHA’s MMI loan guarantees and 98 percent of VA’s loan guarantees, resulting in additional offsetting collections. The subsidy rate for GNMA, which is calculated using FCRA methods, is estimated to be -0.31 percent annually over the 2021-2031 period. | Government National Mortgage Association Mortgage-Backed Securities Programe | `51297-2021-02-mortgages.xlsx` / `Mortgage Progs_2-2021` / R40C2 |

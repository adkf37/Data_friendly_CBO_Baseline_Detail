...
| Field | Value |
|---|---|
| Source file(s) | `51316-2020-03-unemployment.xlsx` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `27925.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51316-2020-03-unemployment.xlsx` | Use this column to trace any row back to its exact source workbook. |

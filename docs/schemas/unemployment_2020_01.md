...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Unemployment & Trade Adjustment` | Combine with source file, row, and column for exact cell provenance. |

# Schema: Childnutrition 0 2024 02
...
| Field | Value |
|---|---|
| Source file(s) | `51293-2024-02-childnutrition_0.xlsx` |
| Source sheet(s) | `Child Nutrition_02-2024` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `30108.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51293-2024-02-childnutrition_0.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Child Nutrition_02-2024` | Combine with source file, row, and column for exact cell provenance. |

...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `SS Trustfunds_01-2025` | Combine with ``source_file`` for a fully qualified provenance reference. |

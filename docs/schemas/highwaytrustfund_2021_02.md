# Schema: Highwaytrustfund 2021 02
...
| Field | Value |
|---|---|
| Source file(s) | `51300-2021-02-highwaytrustfund.xlsx` |
| Source sheet(s) | `HTF_2-2021` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51300-2021-02-highwaytrustfund.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `HTF_2-2021` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Highway Trust Fund Accounts / Highway Account / Flexed Balancesb | `b` | Flexed balances are amounts transferred from the highway account to the transit account. | Flexed Balancesb | `51300-2021-02-highwaytrustfund.xlsx` / `HTF_2-2021` / R16C3 |
| Highway Trust Fund Accounts / Highway Account / Revenues and Interestc | `c` | Some of the taxes that are credited to the Highway Trust Fund are scheduled to expire on September 30, 2022, including the taxes on tires and all but 4.3 cents of the federal tax on motor fuels. However, under the rules governing baseline projections, these estimates reflect the assumption that all of the expiring taxes credited to the fund will continue to be collected after fiscal year 2022. | Revenues and Interestc | `51300-2021-02-highwaytrustfund.xlsx` / `HTF_2-2021` / R17C3 |
| Highway Trust Fund Accounts / Highway Account / Intragovernmental Transfersd | `d` | Section 1204 of the Continuing Appropriations Act, 2021 and Other Extensions Act (P.L. 116-159) required certain intragovernmental transfers from the general fund of the Treasury to the Highway Trust Fund. | Intragovernmental Transfersd | `51300-2021-02-highwaytrustfund.xlsx` / `HTF_2-2021` / R18C3 |
| Highway Trust Fund Accounts / Transit Account / Flexed Balancesb | `b` | Flexed balances are amounts transferred from the highway account to the transit account. | Flexed Balancesb | `51300-2021-02-highwaytrustfund.xlsx` / `HTF_2-2021` / R24C3 |
| Highway Trust Fund Accounts / Transit Account / Revenues and Interestc | `c` | Some of the taxes that are credited to the Highway Trust Fund are scheduled to expire on September 30, 2022, including the taxes on tires and all but 4.3 cents of the federal tax on motor fuels. However, under the rules governing baseline projections, these estimates reflect the assumption that all of the expiring taxes credited to the fund will continue to be collected after fiscal year 2022. | Revenues and Interestc | `51300-2021-02-highwaytrustfund.xlsx` / `HTF_2-2021` / R25C3 |
| Highway Trust Fund Accounts / Transit Account / Intragovernmental Transfersd | `d` | Section 1204 of the Continuing Appropriations Act, 2021 and Other Extensions Act (P.L. 116-159) required certain intragovernmental transfers from the general fund of the Treasury to the Highway Trust Fund. | Intragovernmental Transfersd | `51300-2021-02-highwaytrustfund.xlsx` / `HTF_2-2021` / R26C3 |
| Highway Trust Fund Accounts / Cumulative Shortfalla / Highway Account | `a` | Under current law, the Highway Trust Fund cannot incur negative balances. However, following the rules governing baseline projections in the Balanced Budget and Emergency Deficit Control Act of 1985, CBO’s baseline for surface transportation spending reflects the assumption that obligations presented to the Highway Trust Fund will be paid in full. The memorandum to this table shows the cumulative shortfall of fund balances, assuming spending amounts consistent with CBO’s February 2021 baseline. Following the rules for baseline construction, those amounts are estimated by adjusting the obligation limitations enacted under Public Law 116-260, the Consolidated Appropriations Act, 2021, by projected inflation. | Cumulative Shortfalla | `51300-2021-02-highwaytrustfund.xlsx` / `HTF_2-2021` / R32C2 |

...
| Field | Value |
|---|---|
| Source file(s) | `51307-2023-05-ssdi.xlsx` |
| Source sheet(s) | `SSDI_05-2023` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `142.5` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51307-2023-05-ssdi.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `SSDI_05-2023` | Combine with source file, row, and column for exact cell provenance. |

# Schema: Childsupportenforcement 2021 02
...
| Field | Value |
|---|---|
| Source file(s) | `51295-2021-02-childsupportenforcement.xlsx` |
| Source sheet(s) | `1-CSE_2-2021` |
| Unit(s) | Dollars per participant, Millions of dollars, Millions of people |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51295-2021-02-childsupportenforcement...` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `1-CSE_2-2021` | Combine with source file, row, and column for exact cell provenance. |

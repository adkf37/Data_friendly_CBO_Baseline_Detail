# Schema: Healthinsurance 2020 09
...
| Field | Value |
|---|---|
| Source file(s) | `51298-2020-09-healthinsurance.xlsx` |
| Source sheet(s) | `Table 1`, `Table 1-1`, `Table 2`, `Table 2-1`, `Table 3`, `Table 3-1`, `Table 4-1` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51298-2020-09-healthinsurance.xlsx` | Use this column to trace any row back to its exact source workbook. |

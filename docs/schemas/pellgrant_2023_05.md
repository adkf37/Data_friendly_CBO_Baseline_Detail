...
**Vintage:** 2023-05  
**Rows:** 150  
**Fiscal years covered:** 2019–2023  
...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Pell_05-2023` | Combine with ``source_file`` for a fully qualified provenance reference. |

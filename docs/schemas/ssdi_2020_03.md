...
| Field | Value |
|---|---|
| Source file(s) | `51307-2020-03-ssdi.xlsx` |
| Source sheet(s) | `SSDI` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `4231.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51307-2020-03-ssdi.xlsx` | Use this column to trace any row back to its exact source workbook. |

...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Medicaid_06-2024-rev` | Combine with ``source_file`` for a fully qualified provenance reference. |

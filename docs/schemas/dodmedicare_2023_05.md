...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `DoD-MERHCF_0x-2023` | Combine with ``source_file`` for a fully qualified provenance reference. |

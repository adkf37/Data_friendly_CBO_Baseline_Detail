...
| Field | Value |
|---|---|
| Source file(s) | `51317-2024-02-usda.xlsx` |
| Source sheet(s) | `App PL 117-169`, `USDA 02-2024` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `3720.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51317-2024-02-usda.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `USDA 02-2024` | Combine with source file, row, and column for exact cell provenance. |

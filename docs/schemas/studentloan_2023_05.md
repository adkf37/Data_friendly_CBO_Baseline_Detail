...
| Source sheet(s) | `T3-NewLoans-FCRA_05-2023`, `T6-Subsidies_05-2023` |
| Unit(s) | By Fiscal Year, Percent, Net Annual Loan Volume (Millions of dollars) |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `86151.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `T3-NewLoans-FCRA_05-2023` | Combine with ``source_file`` for a fully qualified provenance reference. |

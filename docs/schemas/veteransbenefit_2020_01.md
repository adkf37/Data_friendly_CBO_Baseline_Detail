# Schema: Veteransbenefit 2020 01
...
| Field | Value |
|---|---|
| Source file(s) | `53725-2020-01-veteransbenefit.xlsx` |
| Source sheet(s) | `Veterans Compensation`, `Veterans Pensions` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `53725-2020-01-veteransbenefit.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Veterans Compensation` | Combine with source file, row, and column for exact cell provenance. |
...
| `category_path` | string | Hierarchy-aware path from table/section headings to the leaf category. | N/A | `By Fiscal Year / Veterans / Number (T...` | Use this field instead of ``category`` when labels repeat in different subprograms. |
...
|---|---|---|---|---|
| By Fiscal Year / Adjustment for Payday Shift / (Millions of dollars)a | `a` | 38 U.S. Code § 5120 directs that if the first day of the month occurs on a holiday or weekend, the Department of Veterans Affairs will make benefit payments on the preceding business day. That will result in one additional paycheck in fiscal years 2022 and 2028 and one fewer paycheck in fiscal years 2024 and 2029. | (Millions of dollars)a | `53725-2020-01-veteransbenefit.xlsx` / `Veterans Compensation` / R18C1 |
| By Fiscal Year / Adjustment for Payday Shift / (Millions of dollars)a | `a` | 38 U.S. Code § 5120 directs that if the first day of the month occurs on a holiday or weekend, the Department of Veterans Affairs will make benefit payments on the preceding business day. That will result in one additional paycheck in fiscal years 2022 and 2028 and one fewer paycheck in fiscal years 2024 and 2029. | (Millions of dollars)a | `53725-2020-01-veteransbenefit.xlsx` / `Veterans Compensation` / R33C1 |
| By Fiscal Year / Adjustment for Payday Shift / (Millions of dollars)a | `a` | 38 U.S. Code § 5120 directs that if the first day of the month occurs on a holiday or weekend, the Department of Veterans Affairs will make benefit payments on the preceding business day. That will result in one additional paycheck in fiscal years 2022 and 2028 and one fewer paycheck in fiscal years 2024 and 2029. | (Millions of dollars)a | `53725-2020-01-veteransbenefit.xlsx` / `Veterans Pensions` / R18C1 |
| By Fiscal Year / Adjustment for Payday Shift / (Millions of dollars)a | `a` | 38 U.S. Code § 5120 directs that if the first day of the month occurs on a holiday or weekend, the Department of Veterans Affairs will make benefit payments on the preceding business day. That will result in one additional paycheck in fiscal years 2022 and 2028 and one fewer paycheck in fiscal years 2024 and 2029. | (Millions of dollars)a | `53725-2020-01-veteransbenefit.xlsx` / `Veterans Pensions` / R33C1 |

...
| Field | Value |
|---|---|
| Source file(s) | `59126-2024-06-aatf.xlsx` |
| Source sheet(s) | `AATF_06-2024` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `18203.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `59126-2024-06-aatf.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `AATF_06-2024` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Airport and Airway Trust Fund / Cash Balances / Start-of-Year Balancea | `a` | Amounts exclude the effects of general fund appropriations for the Airport Improvement Program. | Start-of-Year Balancea | `59126-2024-06-aatf.xlsx` / `AATF_06-2024` / R14C1 |
| Airport and Airway Trust Fund / Cash Balances / Outlaysa | `a` | Amounts exclude the effects of general fund appropriations for the Airport Improvement Program. | Outlaysa | `59126-2024-06-aatf.xlsx` / `AATF_06-2024` / R17C1 |
| Airport and Airway Trust Fund / Cash Balances / End-of-Year Balancea | `a` | Amounts exclude the effects of general fund appropriations for the Airport Improvement Program. | End-of-Year Balancea | `59126-2024-06-aatf.xlsx` / `AATF_06-2024` / R18C1 |
| Airport and Airway Trust Fund / Uncommitted Balances / Change in Balanceb | `b` | The change in uncommitted balances equals excise tax revenues plus interest earnings minus total spending authority. | Change in Balanceb | `59126-2024-06-aatf.xlsx` / `AATF_06-2024` / R22C1 |
| Airport and Airway Trust Fund / Summary of Spending Authority / Grants-in-Aid for Airports (Contract authority)c | `c` | The Airport and Airway Extension Act of 2024 provided $2,041 million in contract authority (a form of mandatory budget authority) for the Airport Improvement Program through May 10, 2024. In keeping with the Balanced Budget and Emergency Deficit Control Act of 1985, CBO assumes that funding provided by that law will continue at the same rate through the rest of 2024 and in each subsequent year, resulting in an annual amount of $3,350 million. Because projections in this table do not take into account events occurring after May 9, 2024, they do not reflect the budgetary effects of legislation enacted after that date, including the FAA Reauthorization Act of 2024. In particular, section 101 of that act increased annual contract authority for the Airport Improvement Program to $4 billion beginning in 2025. | Grants-in-Aid for Airports (Contract authority)c | `59126-2024-06-aatf.xlsx` / `AATF_06-2024` / R28C2 |

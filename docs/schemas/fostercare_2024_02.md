...
| Field | Value |
|---|---|
| Source file(s) | `51299-2024-02-fostercare.xlsx` |
| Source sheet(s) | `Foster Care_02-2024` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `10300.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51299-2024-02-fostercare.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Foster Care_02-2024` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Foster Care, Adoption Assistance, and Guardianship / Estimated Outlays for Other Components / Sequestrationa | `a` | The Infrastructure Investment and Jobs Act extended sequestration for mandatory spending through fiscal year 2031. | Sequestrationa | `51299-2024-02-fostercare.xlsx` / `Foster Care_02-2024` / R39C1 |

...
| Field | Value |
|---|---|
| Source file(s) | `51305-2021-07-pbgc.xlsx` |
| Source sheet(s) | `PBGC_public` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51305-2021-07-pbgc.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `PBGC_public` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Pension Benefit Guaranty Corporation / Components of the Program / Premiumsa | `a` | The Bipartisan Budget Act of 2015 accelerated into 2025 the payment of certain premiums that would otherwise be due in 2026. | Premiumsa | `51305-2021-07-pbgc.xlsx` / `PBGC_public` / R23C2 |
| Pension Benefit Guaranty Corporation / Components of the Program / Other Receiptsb | `b` | “Other receipts” consists of reimbursements from the nonbudgetary trust fund to cover a portion of benefits and administrative costs. | Other Receiptsb | `51305-2021-07-pbgc.xlsx` / `PBGC_public` / R25C2 |

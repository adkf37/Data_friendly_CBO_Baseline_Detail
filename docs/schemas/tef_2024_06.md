...
| Field | Value |
|---|---|
| Source file(s) | `60044-2024-06-tef.xlsx` |
| Source sheet(s) | `TEF-06-2024` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `60044-2024-06-tef.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `TEF-06-2024` | Combine with source file, row, and column for exact cell provenance. |

...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `UI and TAA_02-2026` | Combine with ``source_file`` for a fully qualified provenance reference. |

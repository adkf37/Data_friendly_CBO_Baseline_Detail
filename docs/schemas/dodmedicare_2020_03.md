...
| Unit(s) | Dollars per beneficiary |
...
| `unit` | string | Unit of measure for the ``value`` column, sourced from the parse plan. | N/A | `Dollars per beneficiary` | Common values include 'Millions of dollars', 'Billions of dollars', and 'Thousands'. |

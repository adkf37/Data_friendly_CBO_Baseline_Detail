...
| Field | Value |
|---|---|
| Source file(s) | `51293-2026-02-childnutrition.xlsx` |
| Source sheet(s) | `Child Nutrition_02-2026` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `35435.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51293-2026-02-childnutrition.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Child Nutrition_02-2026` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Child Nutrition Programs / Summer Food Programsa / Estimated Budget Authority | `a` | Includes the Summer Food Service and Summer Electronic Benefits Transfer Programs | Summer Food Programsa | `51293-2026-02-childnutrition.xlsx` / `Child Nutrition_02-2026` / R34C1 |
| Child Nutrition Programs / Summer Food Programsa / Estimated Outlays | `a` | Includes the Summer Food Service and Summer Electronic Benefits Transfer Programs | Summer Food Programsa | `51293-2026-02-childnutrition.xlsx` / `Child Nutrition_02-2026` / R34C1 |
| Child Nutrition Programs / Other Spendingb / Estimated Budget Authority | `b` | “Other Spending” includes the Special Milk Program, the Food Service Management Institute, Team Nutrition, coordinated review, computer support and processing, child nutrition grants for the Northern Mariana Islands and American Samoa, and other activities. It also includes discretionary projects funded in annual appropriation acts. | Other Spendingb | `51293-2026-02-childnutrition.xlsx` / `Child Nutrition_02-2026` / R41C1 |

# Schema: Healthinsurance 2023 05
...
| Field | Value |
|---|---|
| Source file(s) | `51298-2023-05-healthinsurance.xlsx` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `270.7` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51298-2023-05-healthinsurance.xlsx` | Use this column to trace any row back to its exact source workbook. |

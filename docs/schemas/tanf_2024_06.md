...
| Field | Value |
|---|---|
| Source file(s) | `51314-2024-06-tanf.xlsx` |
| Source sheet(s) | `TANF_06-2024` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51314-2024-06-tanf.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `TANF_06-2024` | Combine with source file, row, and column for exact cell provenance. |

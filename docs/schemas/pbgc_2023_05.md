...
| Field | Value |
|---|---|
| Source file(s) | `51305-2023-05-pbgc.xlsx` |
| Source sheet(s) | `PBGC_05-2023` |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `2479.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51305-2023-05-pbgc.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `PBGC_05-2023` | Combine with source file, row, and column for exact cell provenance. |
...
|---|---|---|---|---|
| Pension Benefit Guaranty Corporation / Components of the Program / Premiumsa | `a` | The Bipartisan Budget Act of 2015 accelerated into 2025 the payment of certain premiums that would otherwise be due in 2026. | Premiumsa | `51305-2023-05-pbgc.xlsx` / `PBGC_05-2023` / R22C1 |
| Pension Benefit Guaranty Corporation / Components of the Program / Other Receiptsb | `b` | “Other Receipts” consists of reimbursements from the nonbudgetary trust fund to cover a portion of benefits and administrative costs. | Other Receiptsb | `51305-2023-05-pbgc.xlsx` / `PBGC_05-2023` / R24C1 |

...
| Field | Value |
|---|---|
| Source file(s) | `51307-2021-07-ssdi.xlsx` |
| Source sheet(s) | `SSDI` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51307-2021-07-ssdi.xlsx` | Use this column to trace any row back to its exact source workbook. |

...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `765.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |

...
| Source sheet(s) | `T1-FCRA_07-2021`, `T3-NewLoans-FCRA_07-2021`, `T4-Admin_07-2021`, `T5-IntRates_07-2021`, `T6-FV_07-2021`, `T7-Subsidies_07-2021` |
| Unit(s) | Dollars, Millions of dollars, Percent, Percentage, Thousands |
...
| `value` | float | Parsed numeric value from the source cell. | See ``unit`` column | `2607.0` | Negative values indicate outflows or reductions. Values originally enclosed in parentheses (e.g. ``(123)``) are converted to negative floats. |
...
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `T1-FCRA_07-2021` | Combine with source file, row, and column for exact cell provenance. |

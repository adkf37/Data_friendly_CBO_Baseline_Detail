...
| Field | Value |
|---|---|
| Source file(s) | `51297-2020-01-mortgages.xlsx` |
| Source sheet(s) | `Mortgage Guarantees` |
...
| `source_file` | string | Original CBO workbook filename from ``data/raw/``. | N/A | `51297-2020-01-mortgages.xlsx` | Use this column to trace any row back to its exact source workbook. |
| `source_sheet` | string | Worksheet name within the source workbook. | N/A | `Mortgage Guarantees` | Combine with source file, row, and column for exact cell provenance. |
